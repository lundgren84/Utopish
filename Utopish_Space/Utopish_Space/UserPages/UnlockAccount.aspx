<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UnlockAccount.aspx.cs" Inherits="Utopish_Space.WebForm1" %>
         ...
         <%--   <asp:Button ID="ButtonChangeLoggin" CssClass="logginButton" runat="server" Font-Names="Consolas" Font-Size="Medium" Height="50px" Width="150px" Text="Register"  OnClick="Button3_Click" CausesValidation="false"/>--%>
            ...
            <asp:Panel ID="PanelVerify"  runat="server">
               <table>
                   ...
                   <tr>
                       <td>
                           <asp:Button ID="Button1" CssClass="logginButton" Font-Names="Consolas" runat="server"  Font-Size="Medium" Height="50px" Width="150px" Text="Verify" />
                       </td>
                   </tr>
               </table>
